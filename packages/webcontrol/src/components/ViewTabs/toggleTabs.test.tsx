...
describe("ToggleTabs", () => {
  ...
  describe("RBAC mode (with customerRoleId)", () => {
    it("uses role config from roles-tabs-config.json when role found", () => {
      // customerRoleId "1" = Teaching Leader in BSF Prod workspace (all tabs shown)
      vi.mocked(useGlobalState).mockReturnValue(
        createMockState({
          customerRoleId: "1",
          workspaceId: "df2a9def-d632-4bf3-9799-263d6e33b332", // BSF Prod
          displayModeViews: {
    ...
    it("uses role config when role has restricted tabs (comingSoon)", () => {
      // customerRoleId "3" = Class Administrator (browse has comingSoon: true)
      vi.mocked(useGlobalState).mockReturnValue(
        createMockState({
          customerRoleId: "3",
          workspaceId: "df2a9def-d632-4bf3-9799-263d6e33b332",
          displayModeViews: {
            CHAT: { SHOW: true },
            SEARCH: { SHOW: true },
    ...
    it("shows only Search and Chat when Browse is disabled without comingSoon (Regional Director)", () => {
      // customerRoleId "20" = Regional Director (browse.show=false, no comingSoon)
      vi.mocked(useGlobalState).mockReturnValue(
        createMockState({
          customerRoleId: "20",
          workspaceId: "df2a9def-d632-4bf3-9799-263d6e33b332",
