...
import { AgentChatPanel } from '@sharelyai/ui-agent-chat';

// Standalone @sharelyai/ui-agent-chat: SSE-streamed agent responses with
    ...
    <SharelyProvider>
      <ThemeProvider>
        ...
        <div style={{ padding: '20px' }}>
          ...
          <div style={{ height: '600px', width: '440px', border: '1px solid #ccc', margin: '20px auto' }}>
            {/* spaceId comes from your own flow; '' renders the empty state */}
            <AgentChatPanel spaceId="" botName="Sharely Agent" placeholder="Ask the agent…" />
          </div>
        </div>
      </ThemeProvider>
    </SharelyProvider>
