...
const MODES = [
  ...
  { value: 'bottom-center-floating', label: 'Bottom Center Floating', description: 'Fixed at bottom-center of viewport' },
  { value: 'bottom-right-floating', label: 'Bottom Right Floating', description: 'Fixed at bottom-right of viewport' },
  { value: 'placed-floating', label: 'Placed Floating', description: 'Appears in page flow, opens as centered modal' },
  { value: 'placed-inline', label: 'Placed Inline', description: 'Embedded inline in a container' },
];
...
function ModesDemo() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <p>Select a position mode to see how the widget renders. Click the launcher to open.</p>
        ...
        {MODES.map((m) => (
          <button
            ...
            style={{
              padding: '8px 16px',
              borderRadius: '8px',
              border: activeMode === m.value ? '2px solid #4443C7' : '1px solid #ccc',
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
        ...
        <button
          ...
          style={{
            padding: '8px 16px',
            borderRadius: '8px',
            border: avatarMode === 'expanded' ? '2px solid #4443C7' : '1px solid #ccc',
        ...
        <button
          ...
          style={{
            padding: '8px 16px',
            borderRadius: '8px',
            border: avatarMode === 'circle' ? '2px solid #4443C7' : '1px solid #ccc',
